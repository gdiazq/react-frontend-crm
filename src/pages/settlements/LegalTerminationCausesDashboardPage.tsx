...
export default function SettlementsTerminationDashboardPage() {
  ...
  const loadingLegalTerminationCauses = useStoreLegalTerminationCauses((s) => s.loadingLegalTerminationCauses)
  const loadingLegalTerminationCauseDetail = useStoreLegalTerminationCauses((s) => s.loadingLegalTerminationCauseDetail)
  const loadingToggleStatus = useStoreLegalTerminationCauses((s) => s.loadingToggleStatus)
  ...
  return (
    <section className="min-w-0 space-y-4">
      <header className="rounded-2xl border border-slate-200 bg-white p-6 dark:border-white/10 dark:bg-slate-900/60">
        <h1 className="text-2xl font-bold">Dashboard de terminacion</h1>
      </header>
      ...
      <TableComponent
        ...
        emptyMessage="No hay causas legales de terminacion registradas."
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3 rounded-xl border border-emerald-500/35 bg-emerald-50/20 p-3 dark:border-emerald-400/25 dark:bg-emerald-950/10">
            ...
            <div className="grid gap-2">
              <InputComponent
                id="termination-causes-created-from"
              ...
              />
              <InputComponent
                id="termination-causes-created-to"
          ...
          <div className="space-y-3 rounded-xl border border-amber-500/35 bg-amber-50/15 p-3 dark:border-amber-400/25 dark:bg-amber-950/10">
            ...
            <div className="grid gap-2">
              <InputComponent
                id="termination-causes-updated-from"
              ...
              />
              <InputComponent
                id="termination-causes-updated-to"
