    ...
    <section className="space-y-4">
      ...
      >
        {isEditMode && loadingProjectSpecialtyDetail && (
          <p className="text-sm text-slate-600 dark:text-slate-300">Cargando datos de la especialidad de proyecto...</p>
        )}
        ...
        <InputComponent
          ...
          label="Descripcion"
          type="text"
          placeholder="Ingresa la descripcion de la especialidad de proyecto"
          autoComplete="off"
      ...
      <SaveConfirmComponent
        open={confirmOpen}
        title={isEditMode ? 'Confirmar actualizacion de especialidad' : 'Confirmar creacion de especialidad'}
