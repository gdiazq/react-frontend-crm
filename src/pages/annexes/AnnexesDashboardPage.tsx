  ...
  return (
    <section className="min-w-0 space-y-4">
      <header className="rounded-2xl border border-slate-200 bg-white p-6 dark:border-white/10 dark:bg-slate-900/60">
        <h1 className="text-2xl font-bold">Dashboard de anexos</h1>
      </header>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3 rounded-xl border border-cyan-500/35 bg-cyan-50/20 p-3 dark:border-cyan-400/25 dark:bg-cyan-950/10">
            ...
            <div className="grid gap-2">
              <InputComponent id="annexes-date-from" value={filters.dateFrom} label="Desde" type="date" onValueChange={(v) => handleChangeFilter('dateFrom', v)} />
              <InputComponent id="annexes-date-to" value={filters.dateTo} label="Hasta" type="date" onValueChange={(v) => handleChangeFilter('dateTo', v)} />
            </div>
          </div>
          <div className="space-y-3 rounded-xl border border-emerald-500/35 bg-emerald-50/20 p-3 dark:border-emerald-400/25 dark:bg-emerald-950/10">
            ...
            <div className="grid gap-2">
              <InputComponent id="annexes-created-from" value={filters.createdFrom} label="Desde" type="date" onValueChange={(v) => handleChangeFilter('createdFrom', v)} />
              <InputComponent id="annexes-created-to" value={filters.createdTo} label="Hasta" type="date" onValueChange={(v) => handleChangeFilter('createdTo', v)} />
            </div>
          </div>
          <div className="space-y-3 rounded-xl border border-amber-500/35 bg-amber-50/15 p-3 dark:border-amber-400/25 dark:bg-amber-950/10">
            ...
            <div className="grid gap-2">
              <InputComponent id="annexes-updated-from" value={filters.updatedFrom} label="Desde" type="date" onValueChange={(v) => handleChangeFilter('updatedFrom', v)} />
              <InputComponent id="annexes-updated-to" value={filters.updatedTo} label="Hasta" type="date" onValueChange={(v) => handleChangeFilter('updatedTo', v)} />
            </div>
          </div>
