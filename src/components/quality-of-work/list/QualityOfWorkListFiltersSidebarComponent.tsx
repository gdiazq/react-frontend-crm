...
interface QualityOfWorkListFiltersSidebarComponentProps {
  open: boolean
  onClose: () => void
}

export function QualityOfWorkListFiltersSidebarComponent(props: QualityOfWorkListFiltersSidebarComponentProps) {
  ...
  const loadingAny = loadingQualityOfWork || loadingToggleStatus || loadingStatusOptions
