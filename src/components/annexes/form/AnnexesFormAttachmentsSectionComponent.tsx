...
import { ANNEX_FILES_MAX_COUNT } from '@/factories'

interface AnnexesFormAttachmentsSectionComponentProps {
  files: File[]
...
export function AnnexesFormAttachmentsSectionComponent(props: AnnexesFormAttachmentsSectionComponentProps) {
