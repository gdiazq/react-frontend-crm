...
interface CreateTransferTableCustomRendererParams {
  employeeNameColumnIndex: number
  statusColumnIndex: number
  onViewDetail: (rowId: string) => void
}

export function createTransferTableCustomRenderer({
  employeeNameColumnIndex,
  statusColumnIndex,
  onViewDetail,
}: CreateTransferTableCustomRendererParams): TableCellCustomRenderer {
