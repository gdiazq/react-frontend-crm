...
interface CreateProjectSpecialtiesTableCustomRendererParams {
...
export function createProjectSpecialtiesTableCustomRenderer({
  nameColumnIndex,
  statusColumnIndex,
  onViewDetail,
  getStatusEnabled,
}: CreateProjectSpecialtiesTableCustomRendererParams): TableCellCustomRenderer {
