...
interface CreateLegalTerminationCausesTableCustomRendererParams {
...
export function createLegalTerminationCausesTableCustomRenderer({
  nameColumnIndex,
  statusColumnIndex,
  onViewDetail,
  getStatusEnabled,
}: CreateLegalTerminationCausesTableCustomRendererParams): TableCellCustomRenderer {
