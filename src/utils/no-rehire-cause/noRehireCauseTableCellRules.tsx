...
interface CreateNoRehireCauseTableCustomRendererParams {
...
export function createNoRehireCauseTableCustomRenderer({
  nameColumnIndex,
  statusColumnIndex,
  onViewDetail,
  getStatusEnabled,
}: CreateNoRehireCauseTableCustomRendererParams): TableCellCustomRenderer {
