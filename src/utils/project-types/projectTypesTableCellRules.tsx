...
interface CreateProjectTypesTableCustomRendererParams {
...
export function createProjectTypesTableCustomRenderer({
  nameColumnIndex,
  statusColumnIndex,
  onViewDetail,
  getStatusEnabled,
}: CreateProjectTypesTableCustomRendererParams): TableCellCustomRenderer {
