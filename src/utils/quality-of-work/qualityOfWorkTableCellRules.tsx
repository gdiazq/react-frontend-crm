...
interface CreateQualityOfWorkTableCustomRendererParams {
...
export function createQualityOfWorkTableCustomRenderer({
  nameColumnIndex,
  statusColumnIndex,
  onViewDetail,
  getStatusEnabled,
}: CreateQualityOfWorkTableCustomRendererParams): TableCellCustomRenderer {
