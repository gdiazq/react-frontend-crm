...
const ProjectStatusesDashboardPage = lazy(() => import('@/pages/projects/statuses/ProjectStatusesDashboardPage'))
const ProjectStatusesFormDashboardPage = lazy(() => import('@/pages/projects/statuses/ProjectStatusesFormDashboardPage'))
...
const ProjectTypesDashboardPage = lazy(() => import('@/pages/projects/types/ProjectTypesDashboardPage'))
const ProjectTypesFormDashboardPage = lazy(() => import('@/pages/projects/types/ProjectTypesFormDashboardPage'))
...
const SettlementsDashboardPage = lazy(() => import('@/pages/settlement/main/SettlementsDashboardPage'))
const SettlementFormDashboardPage = lazy(() => import('@/pages/settlement/main/SettlementFormDashboardPage'))
const LegalTerminationCausesDashboardPage = lazy(() => import('@/pages/settlement/legal-termination-causes/LegalTerminationCausesDashboardPage'))
const LegalTerminationCausesFormDashboardPage = lazy(() => import('@/pages/settlement/legal-termination-causes/LegalTerminationCausesFormDashboardPage'))
const SettlementsWorkQualityDashboardPage = lazy(() => import('@/pages/settlement/quality-of-work/WorkQualityDashboardPage'))
const SettlementsWorkQualityFormDashboardPage = lazy(() => import('@/pages/settlement/quality-of-work/WorkQualityFormDashboardPage'))
const SafetyComplianceDashboardPage = lazy(() => import('@/pages/settlement/safety-compliance/SafetyComplianceDashboardPage'))
const SafetyComplianceFormDashboardPage = lazy(() => import('@/pages/settlement/safety-compliance/SafetyComplianceFormDashboardPage'))
const NoRehireCauseDashboardPage = lazy(() => import('@/pages/settlement/no-rehire-cause/NoRehireCauseDashboardPage'))
const NoRehireCauseFormDashboardPage = lazy(() => import('@/pages/settlement/no-rehire-cause/NoRehireCauseFormDashboardPage'))
const TerminationQuizQuestionDashboardPage = lazy(() => import('@/pages/settlement/termination-quiz-question/TerminationQuizQuestionDashboardPage'))
const TerminationQuizQuestionFormDashboardPage = lazy(() => import('@/pages/settlement/termination-quiz-question/TerminationQuizQuestionFormDashboardPage'))
